...
/**
 * Created by BusyLife on 2017/11/2.
 */
...
public class SIMCardUtil {
    ...
    private static final String TAG = SIMCardUtil.class.getSimpleName();
    ...
    private static SIMCardUtil CTelephoneInfo;
    ...
    public synchronized static SIMCardUtil getInstance(Context context) {
        if (CTelephoneInfo == null) {
            CTelephoneInfo = new SIMCardUtil();
        }
        mContext = context;
