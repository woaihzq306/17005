 ...
 * 购买解锁码
 */
public class BuyRechargeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getLayoutContent() {
        return R.layout.activity_buy_recharge;
    }


    @Override
    protected void initView(@Nullable Bundle savedInstanceState) {
        setHeaderTitle("购买充值卡");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            // 提交卡密
            case R.id.buyBtn:
                BuyRechargeApi buyAccountApi = new BuyRechargeApi(nowContext);
